...
CodePilotAI позволяет вести диалог с языковой моделью Google Gemini, используя файлы вашего проекта (из GitHub или локальной папки) в качестве контекста. Эта версия представляет **Code-Graph** — новую технологию анализа, которая позволяет ИИ понимать архитектуру и взаимосвязи в коде, выводя качество ответов на новый уровень.
...
*   **Универсальность:**
    ...
    *   **Анализ кода и текста:** Анализируйте репозитории, локальные проекты или папки с обычными текстовыми документами.
